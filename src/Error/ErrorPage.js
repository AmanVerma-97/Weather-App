...
function ErrorPage() {
  ...
  return (
    <div class="bg-teal-200 h-screen w-full dark:bg-cyan-900 mt-0 py-8">
      <div class="w-10/12 h-4/5 sm:w-6/12 sm:h-4/5 m-auto flex items-center justify-center flex-col flex-wrap bg-slate-800 text-white gap-8 p-4 rounded-md">
        ...
        <Link to="/"> <button class="bg-slate-600 text-yellow-500 font-bold p-2 rounded-md" onClick={resetValue}> BACK </button> </Link>
      </div>
    </div>
